        ...
        <Card className="w-full max-w-md shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold">
              {showMfaInput ? t("login.mfaTitle") : t("register.title")}
            </CardTitle>
            <CardDescription>
              {showMfaInput ? t("login.mfaDesc") : t("register.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {showMfaInput ? (
              ...
              <>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full" disabled={isSubmitting}>
                    {isSubmitting ? t("register.creating") : t("register.createBtn")}
                  </Button>
                </form>
